...
use App\detrupru;
class GuardarRutinaPruebController extends Controller
{
  function __construct()
     ...
     *
     * @param  \App\GuardarRutinaPrueba  $guardarRutinaPrueba
     * @return \Illuminate\Http\Response
     */
    public function show(GuardarRutinaPrueba $guardarRutinaPrueba)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(GuardarRutinaPrueba $guardarRutinaPrueba)
    {
        //
    }
      ...
      $mytime = Carbon::now('America/Guatemala');
        if( $estado_detalle_rutina_prueba[$cont]==1){
              DB::table('detalle_rutina_prueba')
                          ->where('iddetalle_crutina_prueba',$iddetalle_rutina_prueba[$cont])
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(GuardarRutinaPrueba $guardarRutinaPrueba)
    {
        //
    }
}
