	...
	<div class="col-md-12">
		...
		<div class="box box-success">
			<div class="box-header with-border">
				<h3 class="box-title">Nueva valor referencia rutina</h3>
			</div>
      @if (count($errors)>0)
      ...
      @endif
			<!-- /.box-header -->
			<!-- form start -->
			<form role="form" method="POST" action="{{route('valrefru.store')}}" >
					{!! csrf_field() !!}

				<div class="box-body col-md-12">
					<div class="form-group">
						<label for="direccion_fab">Nombre de valor referencia rutina</label>
